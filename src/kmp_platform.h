...
#undef KMP_OS_VXWORKS
#define KMP_OS_VXWORKS 1
#endif
...
#error Unknown OS
        ...
        KMP_OS_OPENBSD || KMP_OS_DARWIN || KMP_OS_HURD || KMP_OS_VXWORKS
#undef KMP_OS_UNIX
...
#if KMP_ARCH_AARCH64 == 0 && defined(__ARM_ARCH_8A__)
#define KMP_ARCH_ARMV8 1
#endif

#if defined(KMP_ARCH_ARMV8) || defined(__ARM_ARCH_7__) ||                      \
    defined(__ARM_ARCH_7R__) || defined(__ARM_ARCH_7A__) ||                    \
...
// TODO: Fixme - This is clever, but really fugly
     ...
     KMP_ARCH_X86 + KMP_ARCH_X86_64 + KMP_ARCH_ARM + KMP_ARCH_PPC64 +          \
         KMP_ARCH_AARCH64 + KMP_ARCH_MIPS + KMP_ARCH_MIPS64 + KMP_ARCH_PPC)
