...
#if KMP_MIC || KMP_OS_DARWIN || KMP_OS_WINDOWS || KMP_OS_VXWORKS || defined(KMP_STUB)
  return 0;
#else
  int (*fptr)();
...
#endif // KMP_MIC || KMP_OS_DARWIN || KMP_OS_WINDOWS || KMP_OS_VXWORKS || defined(KMP_STUB)
}
...
#if !KMP_OS_WINDOWS && !KMP_OS_VXWORKS
