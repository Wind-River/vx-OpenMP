...
#define KMP_HANDLE_SIGNALS ((KMP_OS_UNIX || KMP_OS_WINDOWS) && !KMP_OS_VXWORKS)
...
#if (KMP_ARCH_ARM || KMP_ARCH_X86_64 || KMP_ARCH_AARCH64) && (KMP_OS_LINUX || KMP_OS_VXWORKS)
                           va_list *ap
#else
                           va_list ap
#endif
